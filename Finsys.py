            ...
            if check_login is None:
                ...
                if check_login[4]==usr_nm and check_login[1]==usr_pass:
                    ...
                    def res_wid_sal(event):
                        ...
                        dcanvas.coords("head_lb_usd",dwidth/7,dheight/6.5)
                    ...
                    def crcy_typ(event):
                        if crcy_tps.get()=="$ USD":
                            cmp_name.config(text="Today: $3556345 USD")
                            
                            pass
                        elif crcy_tps.get()=="₹ INR":
                            cmp_name.config(text="Today: ₹3556345 INR")
                            ...
                            cmp_name.config(text="Today: €3556345 EUR")
                            
                            pass
                        else:
                            pass

                    cmp_name=Label(cash_can, text="Today: 3556345 USD",bg="#213b52", fg="White", anchor="center",font=('Calibri 24 bold'))
                    win_inv1 = cash_can.create_window(0, 0, anchor="center", window=cmp_name,tag=("head_lb_usd"))
                    ...
                    crcy_cmp['values'] = ('Change currency','$ USD', '₹ INR', '¥ YEN','€ EUR')
